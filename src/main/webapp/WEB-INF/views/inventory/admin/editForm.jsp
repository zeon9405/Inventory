...
<head>
    ...
    <style>
        ...
        .card-header { background-color: #198754; color: white; border-radius: 15px 15px 0 0 !important; padding: 20px; }
    </style>
</head>
<body>
...
<div class="container form-container">
    <div class="card">
        <div class="card-header text-center">
            <h4 class="mb-0 fw-bold">📝 비품 정보 수정</h4>
        </div>
        <div class="card-body p-4">
            <form action="/admin/modifyItem" method="post">
                ...
                <div class="mb-3">
                    <label for="item_name" class="form-label fw-bold text-secondary">품목명</label>
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-success btn-lg fw-bold">수정 완료</button>
